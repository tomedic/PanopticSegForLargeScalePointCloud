...
class TestPairPlanetary(BasePCRBTest):
    DATASETS = [["p2at_met", "3dmap_dataset/p2at_met/p2at_met.zip"], ["box_met", "3dmap_dataset/box_met/box_met.zip"]]
                ...
                for entry in directory:
                    if entry.is_dir():
                        ...
                        open3d.io.write_point_cloud(
                            pcd_file_name, pcd, write_ascii=True, compressed=False, print_progress=False
                        )
